...
export const profilesData = {
  product_manager: {
    ...
    subtitle: 'Gestão de Produtos Digitais',
    icon: '📱',
    color: 'bg-blue-600',
    elevatorPitch: {
    ...
    achievements: [
      '4 produtos digitais na Unimed (5% da receita = $16M)',
      'Crescimento 25% no Woop App ($50M receita)',
      'Lançamento bem-sucedido do Next Bank',
      'NPS +6% e churn -15% na Unimed',
      'Implementação de AI em produtos de saúde'
    ]
  },
  ...
  program_manager: {
    ...
    subtitle: 'Gestão de Programas Complexos',
    icon: '📊',
    color: 'bg-purple-600',
    elevatorPitch: {
    ...
    achievements: [
      ...
      '$1.4M em ganhos de eficiência no setor público'
    ]
  },
  ...
  strategy_manager: {
    ...
    subtitle: 'Estratégia Corporativa e Inovação',
    icon: '🎯',
    color: 'bg-green-600',
    elevatorPitch: {
    ...
    achievements: [
      'EBITDA +22% na Unimed ($70.4M impacto)',
      'Frameworks OKR & KPI corporativos',
      'Board advisor em transformação digital',
      'Avaliador Programa Inovar Juntos (PUC)',
      'AI-readiness assessment setor público'
    ]
  },
  ...
  pmo_manager: {
    id: 'pmo_manager',
    title: 'PMO Manager',
    subtitle: 'Governança e Excelência Operacional',
    icon: '🏢',
    color: 'bg-orange-600',
    elevatorPitch: {
    ...
    achievements: [
      ...
      'Modelo de governança replicado globalmente',
      'Portal PMO executivo com dashboards',
      'Padronização de práticas ($1.4M economia)',
      'Compliance 100% em migrações críticas'
    ]
  },
  ...
  innovation_manager: {
    ...
    subtitle: 'Transformação Digital e IA',
    icon: '🚀',
    color: 'bg-red-600',
    elevatorPitch: {
    ...
    achievements: [
      'AI para claims triage (-30% tempo processamento)',
      'ML para credit scoring e fraud detection',
      'AI-readiness assessment setor público',
      'Programa de Gestão de Agentes de IA',
      'Mentoria em programas de inovação'
    ]
  }
};
